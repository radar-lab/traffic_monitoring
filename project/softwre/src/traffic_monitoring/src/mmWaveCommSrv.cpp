...
PLUGINLIB_EXPORT_CLASS(traffic_monitoring::mmWaveCommSrv, nodelet::Nodelet);
...
void mmWaveCommSrv::onInit()
{
   ...
   private_nh.getParam("/traffic_monitoring/command_port", mySerialPort);
   
   private_nh.getParam("/traffic_monitoring/command_rate", myBaudRate);
